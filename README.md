...
[![Version](https://img.shields.io/badge/version-2.3.8-blue)](docs/变更日志.md)
...
- **平台模板**：内置 70 个模板，覆盖国内外主流平台（GitHub / OpenAI / AWS / 腾讯云 / 华为云 / 百度千帆 / 通义千问 / DeepSeek / 支付宝 / 微信支付 / 钉钉 / 飞书等）
...
1. 前往 [Releases](https://github.com/mawenshui/omnikey-vault/releases) 下载最新版 `OmniKeyVault-Setup-2.3.8.exe`（安装包）或 `OmniKeyVault-2.3.8-win-x64.zip`（便携版）
2. 安装包：双击运行，按向导完成安装
...
| [平台模板参考](docs/平台模板参考.md) | 模板 schema、70+ 平台完整 JSON 库 |
...
| [变更日志](docs/变更日志.md) | v0.1 → v2.3.8 全部用户可见变更 |
